...
${IMPERAS_ISS} \
    --program /home/amatin/work/imperas_wklds/simple_sum/*.elf \
    ...
    --override iss/cpu0/stf/traceFile=/home/amatin/work/imperas_wklds/simple_sum/imperas_trace/simple_sum.stf \
    --override iss/cpu0/stf/verbose=T \
    --override iss/cpu0/stf/traceMemRead=T \
    --override iss/cpu0/stf/traceMemWrite=T \
    \
    --logfile /home/amatin/work/imperas_wklds/simple_sum/imperas_trace/simple_sum.stf.run.log \
    --verbose \
    "$@" \
