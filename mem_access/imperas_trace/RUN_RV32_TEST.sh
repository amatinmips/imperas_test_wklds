...
${IMPERAS_ISS} \
    --program /home/amatin/work/imperas_wklds/mem_access/*.elf \
    ...
    --override iss/cpu0/stf/traceFile=/home/amatin/work/imperas_wklds/mem_access/imperas_trace/mem_access.stf \
    --override iss/cpu0/stf/verbose=T \
    --override iss/cpu0/stf/traceMemRead=T \
    --override iss/cpu0/stf/traceMemWrite=T \
    \
    --logfile /home/amatin/work/imperas_wklds/mem_access/imperas_trace/mem_access.stf.run.log \
    --verbose \
    "$@" \
